...
4.times do
  User.create(:strava_name => Faker::Lorem.word, :firstname => Faker::Name.first_name, :lastname => Faker::Name.last_name, :email => Faker::Internet.email, :city => Faker::Address.city, :state => Faker::Address.state, :sex => "M",
    :profile_img => Faker::Avatar.image, :token => '61991c295e6ee0223e8ac779c80bd9edf980571a', :strava_id => Faker::Number.number(4), :team_id => 2)
end
4.times do
  User.create(:strava_name => Faker::Lorem.word, :firstname => Faker::Name.first_name, :lastname => Faker::Name.last_name, :email => Faker::Internet.email, :city => Faker::Address.city, :state => Faker::Address.state, :sex => "M",
...
4.times do
  User.create(:strava_name => Faker::Lorem.word, :firstname => Faker::Name.first_name, :lastname => Faker::Name.last_name, :email => Faker::Internet.email, :city => Faker::Address.city, :state => Faker::Address.state, :sex => "M",
    :profile_img => Faker::Avatar.image, :token => '61991c295e6ee0223e8ac779c80bd9edf980571a', :strava_id => Faker::Number.number(4), :team_id => 4)
end

50.times do
  Activity.create(:user_id => User.all.sample.id, :map_polyline => nil, :distance => Random.rand(200), :date_of_activity => Faker::Date.forward(7))
end
